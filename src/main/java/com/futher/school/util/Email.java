...
public class Email {
	public static void sendMail(String fromEmail,String password,String host,String from,String toMail,String mailTitle,String mailContent) throws MessagingException, UnsupportedEncodingException{
//		String fromEmail = "1763608200@qq.com";
//		String password = "wayjltqolxpofhah";
		Properties props = new Properties();//加载一个配置文件
		props.put("mail.smtp.host", host);//存储发送邮件服务器的信息,qq为例(smtp.qq.com)，如果是163则是smtp.163.com
